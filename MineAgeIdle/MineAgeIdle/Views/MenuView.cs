...
namespace MineAgeIdle
{
    internal class MenuView : View
    {
        ...
        private void LoadContent()
        {
            ...
            MenuButton menuForestSprite = new MenuButton(menuForestTexture, new Vector2((Constants.MENU_WIDTH - 176) / 2, currentY), 176, Constants.MENU_BUTTONS_HEIGHT, Color.White, Color.Transparent, 2);
            ...
            MenuButton menuMountainSprite = new MenuButton(menuMountainTexture, new Vector2((Constants.MENU_WIDTH - 176) / 2, currentY), 176, Constants.MENU_BUTTONS_HEIGHT, Color.White, Color.Transparent, 3);
            ...
            MenuButton menuMineSprite = new MenuButton(menuMineTexture, new Vector2((Constants.MENU_WIDTH - 176) / 2, currentY), 176, Constants.MENU_BUTTONS_HEIGHT, Color.White, Color.Transparent, 4);
            ...
            MenuButton menuIslandSprite = new MenuButton(menuIslandTexture, new Vector2((Constants.MENU_WIDTH - 176) / 2, currentY), 176, Constants.MENU_BUTTONS_HEIGHT, Color.White, Color.Transparent, 5);
            ...
            MenuButton menuCasinoSprite = new MenuButton(menuCasinoTexture, new Vector2((Constants.MENU_WIDTH - 176) / 2, currentY), 176, Constants.MENU_BUTTONS_HEIGHT, Color.White, Color.Transparent, 6);
            menuButtons.Add(menuCasinoSprite);

            IncrementHeightPosition();

            Texture2D menuQuitTexture = gameManager.Content.Load<Texture2D>("HUD\\Menu\\Buttons\\QuitButton");
            MenuButton menuQuitSprite = new MenuButton(menuQuitTexture, new Vector2((Constants.MENU_WIDTH - 143) / 2, currentY), 143, Constants.MENU_BUTTONS_HEIGHT, Color.White, Color.Transparent, 7);
